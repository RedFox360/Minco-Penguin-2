...
const bsPokerCommand = new SlashCommand()
    ...
    .setDescription("If the last 3 calls were false, the round ends and everyone gets a card. (Default: False)")
    .setRequired(false))
    .addBooleanOption(option => option
    ...
    .setDescription("Allow each player to see one random card from the next player (Default: False)")
    .setRequired(false)))
    .setCooldown(15)
    .setRun(bsPokerRun);
