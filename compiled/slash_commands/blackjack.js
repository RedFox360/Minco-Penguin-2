...
const blackjackCommand = new SlashCommand()
    ...
    .setName("start")
    .setDescription("Start 1 game of blackjack in the Minco casino! (Blackjack pays 3:2)")
    .addIntegerOption(betOption))
    .addSubcommand(subcommand => subcommand
    .setName("session")
    .setDescription("Start a blackjack session in the Minco casino! (Blackjack pays 3:2)")
    .addIntegerOption(betOption)
