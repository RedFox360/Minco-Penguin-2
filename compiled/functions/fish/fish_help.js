...
const twoToSevenHalfSuit = bold(formatDeckSideways([
    { value: 2, suit: "H" },
    { value: 3, suit: "H" },
    { value: 4, suit: "H" },
    { value: 5, suit: "H" },
...
const ejiHalfSuit = bold(formatDeckSideways([
    { value: 8, suit: "H" },
    { value: 8, suit: "D" },
    { value: 8, suit: "C" },
    { value: 8, suit: "S" },
...
const nineToAceHalfSuit = bold(formatDeckSideways([
    { value: 9, suit: "S" },
    { value: 10, suit: "S" },
    { value: 11, suit: "S" },
    { value: 12, suit: "S" },
...
const exampleHand = bold(formatDeckSideways([
    { value: 4, suit: "D" },
    { value: 5, suit: "S" },
    { value: 1, suit: "j" },
    { value: 13, suit: "C" },
...
If you click the "Table" button, you will see a list of players, and the half suits that each team has earned. If a team has only 1 half suit, all the cards in the half suit will be displayed. If it has more than 1, only *one card* of each half suit will be displayed.`,
    ...
    footer: {
        ...
        icon_url: "https://cdn.discordapp.com/avatars/761087796264960010/a7e4148f9ebba308ee73725381b0772a.webp",
    },
};
...
//# sourceMappingURL=fish_help.js.map